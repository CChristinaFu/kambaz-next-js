  ...
  return (
    <div id="wd-lab1">
      <h2>Lab 1</h2>
        ...
        Each section is usually prefaced with a short title or heading that attempts to summarize the
        topic of the section it precedes. For instance this paragraph is preceded by the heading Heading Tags. 
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                <li>Put water and rice into a claypot and cook on medium for 5 minutes with lid on.</li>
                <li>Put desired vegetables and meat on top of rice and cook for 15 minutes on low.</li>
                <li>Put oil around the lid and cook on medium high for 2 minutes. Serve and enjoy!</li>
            </ol>
